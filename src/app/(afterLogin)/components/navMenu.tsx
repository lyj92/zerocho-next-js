...
export default function NavMenu() {
  ...
  return (
    <>
      <li className="flex flex-row items-center justify-between h-[50px] hover:bg-gray-200  cursor-pointer px-2 rounded-[50px]">
        <Link
          href={"/home"}
        ...
        >
          {segment === "home" ? (
            <>
              ...
              <span className="font-semibold ml-2">홈</span>
            </>
          ) : (
            <>
              <svg
              ...
              <span className="font-base ml-2">홈</span>
            </>
          )}
        </Link>
      </li>
      <li className="flex flex-row items-center justify-between h-[50px] hover:bg-gray-200  cursor-pointer px-2 rounded-[50px]">
        <Link
          href={"/explore"}
          className="flex flex-row items-center mr-1 w-full h-full"
        >
          {segment === "explore" ? (
            <>
              <svg
              ...
              <span className="font-semibold ml-2">탐색하기</span>
            </>
          ) : (
            <>
              <svg
        ...
        >
          {segment === "messages" ? (
            <>
              ...
              <span className="font-semibold ml-2">쪽지</span>
            </>
          ) : (
            <>
              <svg
